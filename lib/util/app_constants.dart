...
class AppConstants {
  static const String appName = 'Nearbykart';
  static const double appVersion = 2.12; ///Flutter Version: 3.24.5

  static const String fontFamily = 'Roboto';
  static const bool payInWevView = false;
  static const int balanceInputLen = 10;
  static const String webHostedUrl = 'https://nearbykart.in';
  static const bool useReactWebsite = false;

  static const String baseUrl = 'https://nearbykartgroups.com';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.telugu, languageName: 'Telugu', countryCode: 'IN', languageCode: 'te'),
  ];
